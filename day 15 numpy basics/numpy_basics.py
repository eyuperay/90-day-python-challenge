...
def main() -> None:
    # 1 Create random predictions (100 values between 0 and 1)
    predictions: np.ndarray = np.random.rand(100)

    print("Predictions:")
    print(predictions)

    # 2️ Statistical calculations
